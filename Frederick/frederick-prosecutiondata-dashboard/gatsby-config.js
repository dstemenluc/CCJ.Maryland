module.exports = {
  siteMetadata: {
    ...
    author: 'Foo',
    title: `Frederick State's Attorney Data Dashboard`,
    ...
    navigation: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Case Outcomes', link: '/case_outcomes' },
          { text: 'Defendant Characteristics', link: '/defendant-characteristics' },
          { text: 'PPIs - Capacity and Efficiency', link: '/ppis' },
          { text: 'PPIs - Community Safety and Well-Being', link: '/ppis-community-safety-and-well-being' },
          { text: 'PPIs - Fairness and Justice', link: '/ppis-fairness-and-justice' },
        ],
  ...
  pathPrefix: process.env.BASEURL || '/frederick/',
  plugins: [
    {
